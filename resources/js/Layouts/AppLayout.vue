			...
			<nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
					...
					<div class="flex justify-between h-16">
						<div class="flex">
							...
							<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
								...
								<NavLink :href="route('reach-us')" :active="route().current('reach-us')">
									{{ $t('Reach Us') }}
								</NavLink>
								...
								<button v-if="getActiveLanguage() !== 'it'" @click="loadLanguageAsync('it')">IT</button>
								<button v-else @click="loadLanguageAsync('en')">EN</button>
							</div>
						</div>
				...
				<div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
					<div class="pt-2 pb-3 space-y-1">
						...
						<ResponsiveNavLink :href="route('reach-us')" :active="route().current('reach-us')">
							{{ $t('Reach Us') }}
						</ResponsiveNavLink>
